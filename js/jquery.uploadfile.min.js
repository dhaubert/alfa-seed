    ...
    e.fn.uploadFile = function(n) {
            ...
            r.on("drop",
                    function(r) {
                        ...
                        if (!n.multiple && i.length > 1) {
                            if (n.showError)
                                e("<div style='color: #FF0400;'>" + n.multiDragErrorStr + "</div>").appendTo(t.errorLog);
                            return
                        }
        ...
        function h(t, n, r) {
            for (var i = 0; i < r.length; i++) {
                if (!p(n, t, r[i].name)) {
                    if (t.showError)
                        e("<div style='color:#FF0400;'><b>" + r[i].name + "</b> " + t.extErrorStr + t.allowedTypes + "</div>").appendTo(n.errorLog);
                    continue
                }
                if (t.maxFileSize != -1 && r[i].size > t.maxFileSize) {
                    if (t.showError)
                        e("<div style='color:#FF0400;'><b>" + r[i].name + "</b> " + t.sizeErrorStr + l(t.maxFileSize) + "</div>").appendTo(n.errorLog);
                    continue
                }
                if (t.maxFileCount != -1 && n.selectedFiles >= t.maxFileCount) {
                    if (t.showError)
                        e("<div style='color:#FF0400;'><b>" + r[i].name + "</b> " + t.maxFileCountErrorStr + t.maxFileCount + "</div>").appendTo(n.errorLog);
                    continue
                }
                n.selectedFiles++;
                var s = t;
        ...
        function m(n, r, i, s) {
            ...
            f.change(function() {
                ...
                if (this.files) {
                    ...
                    if (!p(n, i, f)) {
                        if (i.showError)
                            e("<div style='color:#FF0400;'><b>" + f + "</b> " + i.extErrorStr + i.allowedTypes + "</div>").appendTo(n.errorLog);
                        return
                    }
                ...
                if (t.fileapi && t.formdata) {
                    ...
                    if (i.maxFileCount != -1 && n.selectedFiles + a.length > i.maxFileCount) {
                        if (i.showError)
                            e("<div style='color:#FF0400;'><b>" + d + "</b> " + i.maxFileCountErrorStr + i.maxFileCount + "</div>").appendTo(n.errorLog);
                        return
                    }
        ...
        function g(t, n) {
            ...
            this.abort = e("<div class='ajax-file-upload-#FF0400 ajax-file-upload-abort " + t.formGroup + "'>" + n.abortStr + "</div>").appendTo(this.statusbar).hide();
            this.cancel = e("<div class='ajax-file-upload-#FF0400 ajax-file-upload-cancel " + t.formGroup + "'>" + n.cancelStr + "</div>").appendTo(this.statusbar).hide();
            ...
            this.del = e("<div class='ajax-file-upload-#FF0400'>" + n.deletelStr + "</div>").appendTo(this.statusbar).hide();
            if (n.showQueueDiv)
        ...
        function y(n, r, i, s, o, u) {
            ...
            var l = {cache: false, contentType: false, processData: false, forceSync: false, type: r.method, data: r.formData, formData: r.fileData, dataType: r.returnType, beforeSubmit: function(e, t, u) {
                    ...
                    i.statusbar.append("<div style='color:#FF0400;'>" + r.uploadErrorStr + "</div>");
                    i.cancel.show();
                    n.remove();
                    ...
                    if (r.returnType == "json" && e.type(t) == "object" && t.hasOwnProperty(r.customErrorKeyStr)) {
                        ...
                        if (r.showStatusAfterError) {
                            i.progressDiv.hide();
                            i.statusbar.append("<span style='color:#FF0400;'>ERROR: " + f + "</span>")
                        } else {
                            i.statusbar.hide();
                            i.statusbar.remove()
                        }
                    ...
                    if (e.statusText == "abort") {
                        ...
                        if (r.showStatusAfterError) {
                            i.progressDiv.hide();
                            i.statusbar.append("<span style='color:#FF0400;'>ERROR: " + u + "</span>")
                        } else {
                            i.statusbar.hide();
                            i.statusbar.remove()
                        }
        ...
        var r = e.extend({url: "", method: "POST", enctype: "multipart/form-data", formData: null, returnType: null, allowedTypes: "*", acceptFiles: "*", fileName: "file", formData:{}, dynamicFormData: function() {
            ...
            }, downloadCallback: false, deleteCallback: false, afterUploadAll: false, uploadButtonClass: "ajax-file-upload btn btn-success", dragDropStr: "<span><b> Arraste e solte o arquivo csv aqui</b></span>", abortStr: "Abortar", cancelStr: "Cancelar", deletelStr: "Deletar", doneStr: "OK", multiDragErrorStr: "Arrastar e soltar para múltiplos arquivos não é permitido.", extErrorStr: "não é permitido. Extensões permitidas: ", sizeErrorStr: "não é permitido. Tamanho máximo: ", uploadErrorStr: "Enviar não é permitido", maxFileCountErrorStr: " não é permitido. Número máximo de arquivos: ", downloadStr: "Baixar", customErrorKeyStr: "jquery-upload-file-error", showQueueDiv: false, statusBarWidth: 500, dragdropWidth: 500, showPreview: false, previewHeight: "auto", previewWidth: "100%"}, n);
        this.fileCounter = 1;
